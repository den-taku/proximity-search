...
// pub struct MaximalInducedBipartiteSubgraph {
//     graph: Graph,
//     solutions: HashSet<Vec<usize>>,
// }

// impl MaximalInducedBipartiteSubgraph {
...
//             };
//             // print!("{}: ", v + 1);
//             neighbors.push(self.comp(comp1));
//             // (B_0 \ N(v)) U B_1
//             let comp2 = {
//                 let mut comp2 = b_1
...
//             };
//             // print!("{}: ", v + 1);
//             neighbors.push(self.comp(comp2));
//         }
//         neighbors
//     }
...
//             }
//             component.insert(n);
//             if self.is_bipartite(&component) {
//                 n = 0;
//             } else {
//                 component.remove(&n);
//                 n += 1;
